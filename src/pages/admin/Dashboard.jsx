      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          },
          {
            ...
            change: "+5 this week",
            bgColor: "bg-purple-500",
            description: "Active Registered Users in the Gemora community",
            icon: (
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-cyan-50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-900">Latest Bids</h2>
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {[
            ...
            { 
              label: 'Transactions', 
              color: 'from-lightgreen-500 to-emerald-500',
              icon: (
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            { 
              label: 'Settings', 
              color: 'from-gray-500 to-lightgray-600',
              icon: (
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            { 
              label: 'Analytics', 
              color: 'from-lightyellow-500 to-yellow-500',
              icon: (
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
