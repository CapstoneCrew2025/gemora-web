      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-1">Manage all registered users</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-emerald-100 overflow-hidden transform hover:scale-[1.02] transition-all duration-300">
          <div className="bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-emerald-50 uppercase tracking-wide mb-2">Total Registered Users</p>
                <p className="text-5xl font-bold text-white">{users.length}</p>
                <p className="text-emerald-100 text-sm mt-2">Active accounts in the system</p>
              </div>
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {users.map((user, index) => (
                  <tr key={user.id} className="hover:bg-gradient-to-r hover:from-emerald-50/50 hover:to-green-50/50 transition-all duration-200">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-3 py-1.5 inline-flex text-xs leading-5 font-bold rounded-full ${getRoleBadgeColor(user.role)}`}>
                        {user.role}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 bg-emerald-100 text-emerald-700 hover:bg-emerald-200 rounded-lg font-semibold transition-colors"
                        >
                          View
                        </button>
                        <button
                          onClick={() => handleOpenEditModal(user)}
                          className="px-3 py-1.5 bg-blue-100 text-blue-700 hover:bg-blue-200 rounded-lg font-semibold transition-colors"
                        >
                          Edit
                        </button>
                        {user.role !== 'ADMIN' && (
                          <button
                            ...
                            className="px-3 py-1.5 bg-red-100 text-red-700 hover:bg-red-200 rounded-lg font-semibold transition-colors"
                          >
                            Delete
                          </button>
                        )}
          ...
          <div className="lg:hidden divide-y divide-gray-100">
            {users.map((user) => (
              <div key={user.id} className="p-5 hover:bg-gradient-to-r hover:from-emerald-50/50 hover:to-green-50/50 transition-all duration-200">
                ...
                <div className="space-y-2.5 mb-4 bg-gray-50 p-3 rounded-xl">
                  ...
                  <div className="flex items-center text-sm">
                    {user.idFrontImageUrl || user.idBackImageUrl || user.selfieImageUrl ? (
                      <>
                        <span className="w-2 h-2 bg-emerald-500 rounded-full mr-2 animate-pulse"></span>
                        <span className="text-emerald-600 font-semibold">Documents Available</span>
                      </>
                    ) : (
                      <>
                        <span className="w-2 h-2 bg-gray-300 rounded-full mr-2"></span>
                ...
                <button
                  onClick={() => handleViewUser(user.id)}
                  className="w-full bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white text-sm font-bold py-3 px-4 rounded-xl transition-all shadow-md hover:shadow-lg transform hover:scale-[1.02]"
                >
                  View Full Details
                </button>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="h-16 w-16 bg-white rounded-2xl flex items-center justify-center shadow-lg">
                        <span className="text-emerald-600 font-bold text-2xl">{selectedUser.name.charAt(0).toUpperCase()}</span>
                      </div>
                      <div className="ml-4">
                        <h2 className="text-2xl font-bold text-white">{selectedUser.name}</h2>
                        <p className="text-emerald-100 text-sm font-medium">User ID: #{selectedUser.id}</p>
                      </div>
                    </div>
                    <button
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="mb-8">
                    <div className="flex items-center mb-5">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900">User Information</h3>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-5 rounded-xl border border-gray-200 hover:shadow-md transition-shadow">
                        ...
                        <p className="text-base text-gray-900 font-bold">
                          {selectedUser.contactNumber || <span className="text-gray-400 italic font-normal">Not provided</span>}
                        </p>
                      </div>
                      <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-5 rounded-xl border border-gray-200 hover:shadow-md transition-shadow">
                        <p className="text-sm text-gray-600 font-semibold mb-2 flex items-center">
                        ...
                        <span className={`inline-flex px-4 py-2 text-sm font-bold rounded-xl ${getRoleBadgeColor(selectedUser.role)}`}>
                          {selectedUser.role}
                        </span>
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center mb-5">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900">Identity Documents</h3>
                    </div>
                    ...
                    {!selectedUser.idFrontImageUrl && !selectedUser.idBackImageUrl && !selectedUser.selfieImageUrl ? (
                      <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-10 rounded-2xl text-center border-2 border-dashed border-gray-300">
                        ...
                        <p className="text-lg font-bold text-gray-700 mb-2">No documents uploaded</p>
                        <p className="text-sm text-gray-500">This user hasn't provided any identity documents yet.</p>
                      </div>
                    ) : (
                        ...
                        {selectedUser.idFrontImageUrl && (
                          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border-2 border-gray-200 hover:border-emerald-400 transition-all hover:shadow-lg group">
                            ...
                            <button 
                              ...
                              className="mt-3 w-full text-center text-sm text-emerald-600 hover:text-emerald-700 font-bold bg-emerald-50 hover:bg-emerald-100 py-2 rounded-lg transition-all"
                            >
                              View Full Size →
                            </button>
                          </div>
                  ...
                  <div className="mt-8 pt-6 border-t-2 border-gray-100 flex flex-col sm:flex-row gap-3">
                    <button
                      onClick={handleCloseModal}
                      className="flex-1 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold rounded-xl transition-all text-base"
                    >
                      Close
                    </button>
                    <button
                      ...
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold rounded-xl transition-all text-base shadow-md hover:shadow-lg"
                    >
                      Edit User
                    </button>
                    {selectedUser.role !== 'ADMIN' && (
                      <button
                        ...
                        className="flex-1 px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold rounded-xl transition-all text-base shadow-md hover:shadow-lg"
                      >
                        Delete User
                      </button>
                    )}
            ...
            <div className="text-center">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold rounded-xl transition-all"
                >
                  Cancel
                </button>
                <button
                  onClick={() => handleDeleteUser(deleteConfirm)}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold rounded-xl transition-all shadow-md hover:shadow-lg"
                >
                  Delete
                </button>
              </div>
        ...
        >
          <div className="relative max-w-6xl w-full max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-white text-xl font-bold">{imageModal.title}</h3>
              <button
                onClick={() => setImageModal(null)}
            ...
            <form onSubmit={handleUpdateUser} className="p-6">
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    disabled={editLoading}
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all disabled:bg-gray-100 disabled:cursor-not-allowed font-medium"
                    placeholder="Enter full name"
                  />
                </div>

                <div>
                  <label htmlFor="edit-contact" className="block text-sm font-bold text-gray-700 mb-2">
                    Contact Number
                  </label>
                  <input
                    type="tel"
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border-2 border-gray-200">
                  <div className="flex items-center justify-between text-sm mb-2">
                    ...
                    <span className="font-bold text-gray-900">{editModal.email}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 font-semibold">Role:</span>
                    <span className={`px-3 py-1 text-xs font-bold rounded-full ${getRoleBadgeColor(editModal.role)}`}>
                      {editModal.role}
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-6 flex gap-3">
                <button
                  ...
                  disabled={editLoading}
                  className="flex-1 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={editLoading}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-md hover:shadow-lg"
                >
                  {editLoading ? (
                    <>
