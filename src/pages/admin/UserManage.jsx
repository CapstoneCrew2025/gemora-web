...
const UserManage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-emerald-50/30 to-green-50/20 font-['Inter']">
                  ...
                  <div className="p-6 sm:p-8">
                    ...
                    <div className="mt-8 pt-6 border-t-2 border-gray-100 flex flex-col sm:flex-row gap-3">
                      ...
                      <button
                        ...
                        className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-extrabold rounded-xl transition-all text-base shadow-md hover:shadow-lg font-['Poppins']"
                      >
                        Edit User
                      </button>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-sm font-bold">Update user information</p>
                    </div>
                  </div>
                  <button
                    onClick={() => {
              ...
              <form onSubmit={handleUpdateUser} className="p-6">
                <div className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      disabled={editLoading}
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all disabled:bg-gray-100 disabled:cursor-not-allowed font-semibold"
                ...
                <div className="mt-6 flex gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={editLoading}
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-extrabold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-md hover:shadow-lg font-['Poppins']"
                  >
                    {editLoading ? (
                      <>
