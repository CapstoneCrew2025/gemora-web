...
const Sidebar = ({ isOpen }) => {
  const menuItems = [
    ...
    { icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', label: 'Users' },
  ...
  return (
    <div
      className={`bg-green-800 text-white w-64 min-h-screen ${
        isOpen ? 'block' : 'hidden'
        ...
        <nav>
          {menuItems.map((item, index) => (
            <a
              key={index}
              href="#"
              className="block px-4 py-3 mb-2 rounded hover:bg-green-700 transition-colors duration-200"
            >
